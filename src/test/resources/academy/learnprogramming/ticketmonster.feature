Feature: Test TicketMonster
  Scenario: Purchase Tickets
    ...
    And I click the "Rock concert of the decade" link waiting up to "10" seconds
    And I select the option "Toronto : Roy Thomson Hall" from the "venueSelector" drop down list waiting up to "10" seconds
    And I click the "bookButton" button waiting up to "10" seconds
    And I select the option "A - Premier platinum reserve" from the "sectionSelect" drop down list waiting up to "10" seconds
